const styles = {
    ...
    heading1: "w-full text-white font-headingFont font-semibold md:leading-[65px] leading-[42px] md:text-[64px] text-[40px] mt-0 xs:mt-3 ",
    heading2: "text-gradient  md:text-[30px] text-[35px] font-headingFont font-semibold md:leading-full leading-[37px] "
}
